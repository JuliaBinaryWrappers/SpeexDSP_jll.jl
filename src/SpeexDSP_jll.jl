...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SpeexDSP_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f2f9631b-9a4e-5b48-9975-88f638ec36a7"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SpeexDSP", artifacts_toml) for e in artifacts["SpeexDSP"]]
...
if best_platform === nothing
    @debug("Unable to load SpeexDSP; unsupported platform $(triplet(platform_key_abi()))")
else
