# Autogenerated wrapper script for SpeexDSP_jll for x86_64-w64-mingw32
export libspeexdsp
...
const libspeexdsp_splitpath = ["bin", "libspeexdsp-1.dll"]
...
const libspeexdsp = "libspeexdsp-1.dll"
