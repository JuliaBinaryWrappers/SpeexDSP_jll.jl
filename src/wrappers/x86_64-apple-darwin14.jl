# Autogenerated wrapper script for SpeexDSP_jll for x86_64-apple-darwin14
export libspeexdsp
...
const libspeexdsp_splitpath = ["lib", "libspeexdsp.1.dylib"]
...
const libspeexdsp = "@rpath/libspeexdsp.1.dylib"
